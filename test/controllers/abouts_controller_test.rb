...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { about: @about.about, address: @about.address, email: @about.email, name: @about.name, phone: @about.phone, resume: @about.resume }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { about: @about.about, address: @about.address, email: @about.email, name: @about.name, phone: @about.phone, resume: @about.resume }
    assert_redirected_to about_path(assigns(:about))
  end
